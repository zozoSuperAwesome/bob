...
<!-- Bootstrap-->
<link href="dashboardUi/lib/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
<!--Common Plugins CSS -->
<link href="dashboardUi/css/plugins/plugins.css" rel="stylesheet">
<!-- 탭 Plugins CSS -->
<link href="dashboardUi/css/plugins/plugins.css" rel="stylesheet">
<link href="dashboardUi/css/style.css" rel="stylesheet">
<!--fonts-->
<link href="dashboardUi/lib/line-icons/line-icons.css" rel="stylesheet">
<link href="dashboardUi/lib/font-awesome/css/fontawesome-all.min.css" rel="stylesheet">
<link href="dashboardUi/lib/chartist/chartist.min.css" rel="stylesheet" />
<link href="dashboardUi/css/chartist-custom.css" rel="stylesheet" />
<!-- jvectormap -->
<link href="dashboardUi/lib/vector-map/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
<link href="dashboardUi/css/style.css" rel="stylesheet">
...
<!--fonts-->
<link href="dashboardUi/lib/line-icons/line-icons.css" rel="stylesheet">
<link href="dashboardUi/lib/font-awesome/css/fontawesome-all.min.css"
	rel="stylesheet">
<link href="dashboardUi/css/style1.css" rel="stylesheet">
				...
				<div style="margin-top: 25px; margin-bottom: 1450px;">
					...
					<ul class="nav nav-pills" role="tablist">
						<li role="presentation" class="nav-item"
							...
							role="tab" data-toggle="tab"><h4>스터디카페</h4></a></li>
						<li role="presentation" class="nav-item"
							style="text-align: center; width: 45%"><a class="nav-link"
							href="#tb2" aria-controls="tb2" role="tab" data-toggle="tab"><h4>스투더</h4></a></li>
					</ul>
								...
								<div>
									...
									<ul class="nav nav-pills" role="tablist"
										...
										<li role="presentation" class="nav-item" style="width: 18%;"><a
											...
											aria-controls="total_cafe" role="tab" data-toggle="tab"><h4>전체</h4></a></li>
										<li role="presentation" class="nav-item" style="width: 18%;"><a
											class="nav-link" href="#profile" aria-controls="reser_cafe"
											role="tab" data-toggle="tab"><h4>예약</h4></a></li>
										<li role="presentation" class="nav-item" style="width: 18%;"><a
											class="nav-link" href="#messages" aria-controls="end_cafe"
									...
									<div class="tab-content pt-3" style="margin-left: 4%">
										<!--전체 스투더-->
										<div role="tabpanel" class="tab-pane show active" id="total_cafe">
											<p class="mb-0 text-muted">
<!--개인마이페이지 스투더 목록컨텐츠-->
											
										</div>
<!--승인대기중인 스투더-->
										<div role="tabpanel" class="tab-pane" id="reser_cafe">
											<p class="mb-0 text-muted">
												<!--개인마이페이지 스투더 목록컨텐츠-->
...
<!--진행중인 스투더-->
										<div role="tabpanel" class="tab-pane" id="end_cafe">
...
<!--개인마이페이지 스투더 목록컨텐츠-->
		...
		<script type="text/javascript" src="dashboardUi/js/plugins/plugins1.js"></script>
		<!--  <script type="text/javascript" src="js/appUi-custom.js"></script>  -->
		<script type="text/javascript" src="dashboardUi/lib/peity/jquery.peity.min.js"></script>
		<script>
			//            $(function () {
			//                 /**peity**/
			//                 $(".donut1").peity("donut", {
